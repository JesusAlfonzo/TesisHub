...
// CORRECCIÓN: Agregamos Link y route
...
import { route } from 'ziggy-js'; // Asegurado que route esté disponible
...
// Accedemos a las carreras globales (Inyectadas en el Middleware)
const page = usePage();
// @ts-ignore
...
// Watchers para activar los filtros
...
// Diccionario de colores simples para badges de carrera (Opcional, visual)
        ...
        <div class="flex flex-col gap-6 p-4">
            ...
            <div class="flex flex-col md:flex-row gap-4 justify-between items-end md:items-center bg-sidebar-accent/20 p-6 rounded-xl border border-sidebar-border">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    ...
                    <!-- Filtro Carrera (Select Nativo Estilizado) -->
                    <div class="relative w-full md:w-64">
                        <select
            ...
            <div v-if="tesis.data.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card v-for="item in tesis.data" :key="item.id" class="flex flex-col hover:shadow-lg transition-shadow duration-200 dark:hover:border-primary/50">
                    ...
                    <CardFooter class="pt-0">
                        <!-- 🚨 CORRECCIÓN: Botón "Ver Detalles" ahora es un Link Inertia 🚨 -->
