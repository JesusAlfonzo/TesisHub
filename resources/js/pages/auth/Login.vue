...
<template>
    <AuthBase title="Bienvenido de nuevo" description="Ingresa tus credenciales para acceder al repositorio">
        ...
        <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }"
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <Input id="email" type="email" name="email" required autofocus :tabindex="1"
                            autocomplete="email" placeholder="nombre@iujo.edu.ve"
                ...
                <Button type="submit" class="w-full mt-2 font-semibold shadow-md transition-all hover:scale-[1.01]"
                    size="lg" :tabindex="4" :disabled="processing">
