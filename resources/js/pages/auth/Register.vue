...
<template>
    <AuthBase title="Únete a la Comunidad" description="Completa el formulario para registrar tu perfil de estudiante">
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            ...
            <div class="grid gap-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <Input id="name" v-model="form.name" type="text" required autofocus autocomplete="name"
                                placeholder="Nombre Completo" class="pl-9 bg-background/50 focus:bg-background" />
                        </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <Input id="cedula" v-model="form.cedula" type="text" required placeholder="Cedula"
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <Input id="email" v-model="form.email" type="email" required autocomplete="username"
                            placeholder="Correo Institucional" class="pl-9 bg-background/50 focus:bg-background" />
                    </div>
                ...
                <Button type="submit" class="mt-4 w-full font-semibold shadow-md transition-all hover:scale-[1.01]"
                    size="lg" :disabled="form.processing">
