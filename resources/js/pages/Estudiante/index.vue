...
// Función para eliminar con confirmación nativa (Simple para MVP)
                            ...
                            <tr v-for="item in tesis" :key="item.id" class="border-b transition-colors hover:bg-muted/50">
                                ...
                                <td class="p-4 align-middle text-right">
                                    <div class="flex justify-end gap-2">
                                        <!-- Botón Ver (Si existe archivo) -->
                                        <a v-if="item.ruta_archivo" :href="'/storage/' + item.ruta_archivo" target="_blank">
                                            <Button variant="ghost" size="icon" title="Ver PDF">
                                                <Eye class="h-4 w-4" />
                                            </Button>
                                        </a>

                                        <!-- Botón Editar (Bloqueado si aprobado) -->
                                        ...
                                        <!-- Botón Eliminar (Bloqueado si aprobado) -->
                                        <Button 
